...
Define how individual shell commands are executed on a connected host, including output capture, timeout and cancellation, environment and working-directory control, disconnect handling, and execution metadata.
